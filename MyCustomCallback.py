...
class CallbackmIoU(Callback):
    ...
    def __init__(self, pathTest, lr, pathRGB, pathSEG, pathSoft, pathGraphs, lr_base_on_epochs=True, max_iter=0,
        ...
        :param pathTest: folder path current training
        :param lr: learning rate
        :param pathRGB: path validation images
        :param pathSEG: path validation ground truth images
        :param pathSoft: path validation softmax
        :param pathGraphs:
        :param lr_base_on_epochs: true or false, if learning rate decrease based on the number of iteration (epochs)
                or based on the max-iteration parameters
        :param max_iter: learning rate should be zero on this number of iteration if lr_based_on_epochs is False
        :param poly_lr: true or false, true if it is used the poly learning rate
        """
    ...
    def on_train_batch_begin(self, batch, logs=None):
        """
        Poly learning rate implementation
        """
        if self.poly_lr:
